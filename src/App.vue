<template>
    <div id="app">
        ...
        <div class="outter" :class="{'hideLeft':$route.path.split('/').length>2}">
            <!--通用头部-->
            <header class="app-header" :class="{'header-hide':!$store.state.headerStatus}" v-show="flag">
            ...
            <!--四个门面页 “微信” “通讯录” “发现” “我”-->
            <section class="app-content" v-show="this.$store.state.flag">
                <keep-alive>
                    <router-view name="default" ></router-view>
                </keep-alive>
            </section>
            <!--底部导航 路由 -->
            <footer class="app-footer" v-show="flag">
                <wx-nav></wx-nav>
            </footer>
        </div>
        <!--其他店内页集合 有过渡效果-->
